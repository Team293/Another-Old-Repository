...
public class OI {
	...
	public OI(){
		...
		JoystickButton switch2dn=new JoystickButton(launchpad, 2);
		...
		switch4dn.whenPressed(new FeederAngle(0));
		switch6dn.whenPressed(new FeederFullUp());
		switch2dn.whenPressed(new FeederAngle(30));
		switch3dn.whileHeld(new FeederThrottle(1));
		switch5dn.whileHeld(new FeederRelease(-1));
